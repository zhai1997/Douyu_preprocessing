# -*- coding: utf-8 -*-
"""
Created on Sat May 22 09:39:12 2021
...
streamer_ls=pd.concat([pd.read_csv('top100/top100_wyjj.csv').assign(flag='top'),
                      pd.read_csv('top100/top100_yltd.csv').assign(flag='top'),
                      pd.read_csv('top100/mid100_wyjj.csv').assign(flag='mid'),
                      pd.read_csv('top100/mid100_yltd.csv').assign(flag='mid')])
...
output_folder='danmu_new_topmid'
...
def my_filter(ser):
    ...
    chunk=chunk[chunk.room_id.isin(list(streamer_ls.room_id))]
